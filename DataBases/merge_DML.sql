...
VALUES ('ADMIN', '1250', '관리자', '1990-12-27', '남자', '010-5657-2123', 'ADMIN', '서울특별시 송파구 가락로 232', '126-5 서울탑빌라트', '05644'),
...
VALUES ('디아블로 까베르네 쇼비뇽', 'Casillero del Diablo Cabernet Sauvignon', 3.0, '콘차이 토로', '카베르네 쇼비뇽', '칠레', '칠레', '레드', 13.5, 12,800, '이미지', '파일', '중간', '중간', '약함', '중간', '양고기'),
		('닥터 린드만 포피리 블랑', 'Lindeman Porphyry Blanc', 3.0, '린드망', '소비뇽블랑', '호주', '호주', '화이트', 9.0, 12,900, '이미지', '파일', '중간', '중간', '약함', '중간', '과일, 생선'),
