...
(
  ...
  COUPON_DATETIME1    VARCHAR(100) NOT NULL COMMENT '쿠폰기한1',
  COUPON_DATETIME2    VARCHAR(100) NOT NULL COMMENT '쿠폰기한2',
  C_ATTACHFILE_SEQ    VARCHAR(100) NULL     COMMENT '첨부파일일련번호',
  C_ORIGINALFILE_NAME VARCHAR(100) NULL     COMMENT '원본파일명',
  C_PHYSICALFILE_NAME VARCHAR(100) NULL     COMMENT '첨부파일명',
...
(
  ...
  EVENT_START             VARCHAR(100) NULL     COMMENT '이벤트시작일',
  EVENT_END               VARCHAR(100) NULL     COMMENT '이벤트종료일',
  EVENT_FILE              VARCHAR(100) NULL     COMMENT '이벤트첨부파일',
  EVENT_ATTACHFILE_SEQ    VARCHAR(100) NULL     COMMENT '이벤트첨부파일일련번호',
  EVENT_ORIGINALFILE_NAME VARCHAR(100) NULL     COMMENT '이벤트원본파일명',
  EVENT_PHYSICALFILE_NAME VARCHAR(100) NULL     COMMENT '이벤트첨부파일명',
...
(
  ...
  NOTICE_ATTACHFILE_SEQ    VARCHAR(100) NULL     COMMENT '공지첨부파일일련번호',
  NOTICE_ORIGINALFILE_NAME VARCHAR(100) NULL     COMMENT '공지원본파일명',
  NOTICE_PHYSICALFILE_NAME VARCHAR(100) NULL     COMMENT '공지첨부파일명',
  USER_UID                 VARCHAR(100) NOT NULL COMMENT '회원아이디',
...
(
  ...
  USER_UID       VARCHAR(100) NOT NULL COMMENT '회원아이디',
  WINE_UID       INT          NOT NULL COMMENT '와인UID',
  STORE_PRICE    INT NULL     COMMENT '판매가',
  STORE_DELIVERY INT NULL     COMMENT '배송비',
...
(
  ...
  POST           VARCHAR(100) NOT NULL COMMENT '우편번호',
