package com.mango.mango_final_project.utils;

public class Paginations {
  private int pageScale = 10; // 한 페이지당 게시물 갯수
  private int blockScale = 5; // 블록당 페이지 수
  ...
  private int pageBegin; // 페이지 내에서 시작 게시물 번호
  private int pageEnd; // 페이지 내에서 마지막 게시물 번호
  private int blockStart; // 페이지 블록 내에서 시작 페이지 번호
  private int blockEnd; // 페이지 블록 내에서 마지막 페이지 번호
