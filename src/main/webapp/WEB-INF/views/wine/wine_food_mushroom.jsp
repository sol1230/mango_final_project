  ...
  <body>
    ...
    <div class="container mb-5">
      <nav class="navbar navbar-light">
        ...
        >
          <div class="col fs-3 mt-5 fw-bold">버섯</div>
    ...
    <%@ include file="../etc/details_select.jsp" %>
      ...
      <div class="mt-5 ">
        <div class="mb-5">
          ...
          <form action="/wine/wine_mushroom/select/1" method="get">
      ...
      <ul class="pagination pagination-sm justify-content-center mt-5">
        <li class="page-item">
	      ...
	      <c:forEach var="i" begin="${_pagination.blockStart}" end="${_pagination.blockEnd}">
    	    <li class="page-item"><a class="page-link" href="/wine/wine_mushroom/${i}">${i}</a></li>
        </c:forEach>
	      <li class="page-item">
